...
from evaluation.metrics.custom_gevals import build_single_turn_gevals
...
async def main() -> None:
    ...
    goldens = load_json(eval_root / "datasets" / "single_turn_goldens.json")
    ...
    for golden in goldens:
        trace = await adapter.run_single_turn(golden["input"])
    ...
    metrics = [
        ...
        *build_single_turn_gevals(thresholds, judge_model=judge_model),
    ]
